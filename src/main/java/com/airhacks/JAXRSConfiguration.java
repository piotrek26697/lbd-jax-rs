...
public class JAXRSConfiguration extends Application
{
	...
	public Set<Class<?>> getClasses()
	{
		...
		classes.add(pl.fis.logic.errors.handlers.ConstraintViolationMapper.class);
		classes.add(pl.fis.logic.SpaceFleetHandler.class);
		classes.add(pl.fis.logic.errors.handlers.EntityNotFoundMapper.class);
		classes.add(pl.fis.logic.UserLanguage.class);
		classes.add(pl.fis.logic.serializers.LocalDateSerializer.class);
		classes.add(pl.fis.logic.serializers.LocalDateDeserializer.class);
		classes.add(pl.fis.logic.serializers.LocalDateAdapter.class);
		classes.add(pl.fis.data.DataBase.class);
		classes.add(pl.fis.logic.errors.ResourceNotFound.class);
